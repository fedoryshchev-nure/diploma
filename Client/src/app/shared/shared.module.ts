...
@NgModule({
  declarations: [CoursesListComponent, CoursesListItemComponent, CourseComponent, LessonsListComponent, LessonsListItemComponent],
  imports: [
    CommonModule,
    RouterModule,
    MatPaginatorModule
  ],
  exports: [CoursesListComponent, CourseComponent, LessonsListComponent]
})
